DECLARE @schemaName nvarchar(255) = 'ActiveDirectoryManagement'
...
declare T cursor  for
	...
	WHERE T.TABLE_TYPE = 'VIEW' AND table_schema IN ('ActiveDirectoryManagement') and table_name NOT IN ('date', 'time')-- and table_name = 'customer'
