...
-- post deployment script om test cases mee te nemen voor de XML import

-- sdk 318  (xml)

	if not exists 
	(select distinct auditdwkey from OGDW_Metadata.log.Audit where AuditDWKey=1003) 
	...
	values(1003,1003,318,'GVBLokaal XML Files','XML','GVBLokaal',0,null,null,null,0,'2015-01-30 16:57:10.427',0,NULL,0,0,null)
...
insert into topdesk.soortbinnenkomst (naam,unid,AuditDWKey,SourceDatabaseKey)
    values ( 'NAAM-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','UNID-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','10003','318' )
-- Table : object
...
insert into topdesk.dnolink (unid,ref_naam,AuditDWKey,SourceDatabaseKey)
    values ( 'UNID-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','REF_NAAM-XXXXXXXXXXXXXXXXXXXXX-10003','10003','318' )
-- Table : dnocontract
...
insert into topdesk.oplossingen (unid,korteomschrijving,AuditDWKey,datwijzig,SourceDatabaseKey)
    values ( 'UNID-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','KORTEOMSCHRIJVING-XXXXXXXXXXXX-10003','10003','2016-07-22 07:40:42.000','318' )
...
insert into topdesk.change_template (briefdescription,unid,AuditDWKey,datwijzig,SourceDatabaseKey)
    values ( 'BRIEFDESCRIPTION-XXXXXXXXXXXXX-10003','UNID-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','10003','2016-07-22 07:40:42.000','318' )
...
insert into topdesk.changeActivity (approved,approveddate,briefdescription,categoryid,changeid,currentplantimetaken,dataanmk,datwijzig,number,operatorgroupid,operatorid,originalplantimetaken,changephase,plannedfinaldate,plannedstartdate,rejected,rejecteddate,resolved,resolveddate,skipped,skippeddate,started,starteddate,status,subcategoryid,timetaken,uidaanmk,uidwijzig,unid,activitystatusid,maystart,ref_change_brief_description,AuditDWKey,SourceDatabaseKey,activitytemplateid)
    values ( '1','2016-07-22 07:40:42.000','BRIEFDESCRIPTION-XXXXXXXXXXXXX-10003','CATEGORYID-XXXXXXXXXXXXXXXXXXX-10003','CHANGEID-XXXXXXXXXXXXXXXXXXXXX-10003','1','2016-07-22 07:40:42.000','2016-07-22 07:40:42.000','NUMBER-XXXXXXXXXXXXXXXXXXXXXXX-10003','OPERATORGROUPID-XXXXXXXXXXXXXX-10003','OPERATORID-XXXXXXXXXXXXXXXXXXX-10003','1','1','2016-07-22 07:40:42.000','2016-07-22 07:40:42.000','1','2016-07-22 07:40:42.000','1','2016-07-22 07:40:42.000','1','2016-07-22 07:40:42.000','1','2016-07-22 07:40:42.000','1','SUBCATEGORYID-XXXXXXXXXXXXXXXX-10003','1','UIDAANMK-XXXXXXXXXXXXXXXXXXXXX-10003','UIDWIJZIG-XXXXXXXXXXXXXXXXXXXX-10003','UNID-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','ACTIVITYSTATUSID-XXXXXXXXXXXXX-10003','1','REF_CHANGE_BRIEF_DESCRIPTION-X-10003','10003','318','ACTIVITYTEMPLATEID-XXXXXXXXXXX-10003' )
...
insert into topdesk.change_activitytemplate (number,unid,AuditDWKey,SourceDatabaseKey,operatorgroupid,duration_in_minutes,duration_in_workdays)
    values ( 'NUMBER-XXXXXXXXXXXXXXXXXXXXXXX-10003','UNID-XXXXXXXXXXXXXXXXXXXXXXXXX-10003','10003','318','OPERATORGROUPID-XXXXXXXXXXXXXX-10003','1','1' )
