...
, change.isurgent as Urgency
 ...
 from TOPdesk.change
left join TOPdesk.actiedoor as actiedoor2 on actiedoor2.unid = change.canceledbypersonid and actiedoor2.AuditDWKey = change.AuditDWKey
 and actiedoor2.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.actiedoor as actiedoor on actiedoor.unid = change.canceledbyoperatorid and actiedoor.AuditDWKey = change.AuditDWKey
 and actiedoor.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.gebruiker as gebruiker on gebruiker.unid = change.uidaanmk and gebruiker.AuditDWKey = change.AuditDWKey
 and gebruiker.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.gebruiker as gebruiker2 on gebruiker2.unid = change.uidwijzig and gebruiker2.AuditDWKey = change.AuditDWKey
 and gebruiker2.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.classificatie as classificatie on classificatie.unid = change.categoryid and classificatie.AuditDWKey = change.AuditDWKey
 and classificatie.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.actiedoor as actiedoor3 on actiedoor3.unid = change.managerid and actiedoor3.AuditDWKey = change.AuditDWKey
 and actiedoor3.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.vestiging as vestiging on vestiging.unid = change.aanmeldervestigingid and vestiging.AuditDWKey = change.AuditDWKey
 and vestiging.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.afdeling as afdeling on afdeling.unid = change.aanmelderafdelingid and afdeling.AuditDWKey = change.AuditDWKey
 and afdeling.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.wijziging_impact as wijziging_impact on wijziging_impact.unid = change.impactid and wijziging_impact.AuditDWKey = change.AuditDWKey
 and wijziging_impact.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.[object] as [object] on [object].unid = change.objectid and [object].AuditDWKey = change.AuditDWKey
 and [object].SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.actiedoor as actiedoor4 on actiedoor4.unid = change.operatorgroupid and actiedoor4.AuditDWKey = change.AuditDWKey
 and actiedoor4.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.incident as incident on incident.unid = change.incidentid and incident.AuditDWKey = change.AuditDWKey
 and incident.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.change_priority as change_priority on change_priority.unid = change.priorityid and change_priority.AuditDWKey = change.AuditDWKey
 and change_priority.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.wijzigingstatus as wijzigingstatus on wijzigingstatus.unid = change.statusid and wijzigingstatus.AuditDWKey = change.AuditDWKey
 and wijzigingstatus.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.classificatie as classificatie2 on classificatie2.unid = change.subcategoryid and classificatie2.AuditDWKey = change.AuditDWKey
 and classificatie2.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.change_template as change_template on change_template.unid = change.templateid and change_template.AuditDWKey = change.AuditDWKey
 and change_template.SourceDatabaseKey = change.SourceDatabaseKey
left join TOPdesk.wbaanvraagtype as wbaanvraagtype on wbaanvraagtype.unid = change.typeid and wbaanvraagtype.AuditDWKey = change.AuditDWKey
