CREATE PROCEDURE [shared].[LoadDimTime]
(
	@db nvarchar(64)
)
AS
...
DECLARE @SQLString nvarchar(max) = 'SELECT @recordCount = COUNT(TimeKey) FROM ' + @db + '.Dim.[Time]'
DECLARE @recordCount int
EXECUTE sp_executesql @SQLString, N'@recordCount int OUTPUT', @recordCount = @recordCount OUTPUT
