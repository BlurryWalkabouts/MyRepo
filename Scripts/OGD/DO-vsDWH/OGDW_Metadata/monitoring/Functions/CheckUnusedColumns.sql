CREATE FUNCTION [monitoring].[CheckUnusedColumns]
(
...
SELECT
	UnusedColumns = MD_SourceColumn
FROM
	metadata
EXCEPT
SELECT
	LEFT(all_trans.SourceColumn,64) -- Afgekapt op 64 characters vanwege limitaties Microsoft.Jet.OleDB 
FROM
	all_trans
